...
class InputFeatures(object):
	def __init__(self, example_id, choices_features, label):
		...
		self.choices_features = [
			...
			for input_ids, attention_mask, token_type_ids, gpre, ghyp, concept, adj_matrix, in choices_features
		]
		self.label = label
...
def convert_examples_to_features(args,
	...
	for example_index, example in enumerate(examples):
		...
		for ending_index, ending in enumerate(example.endings):
			...
			choices_features.append((input_ids, attention_mask, token_type_ids, gpre, ghyp,  concept, adj_matrix))
