...
class ARCProcessor(DataProcessor):
	...
	def get_train_examples(self, data_dir,part_train):
		logger.info("LOOKING AT {} train".format(data_dir))
		return self._create_train_examples(self._read_csv(os.path.join(data_dir,"Train_Final_complete.csv")),part_train, type="train")
	...
	def _create_train_examples(self, lines: List[List[str]],p, type:str):
		# Create examples for training and dev set
		...
		out_sw_2_fp = "/index_list"+str(z)+"_"+str(xy[0])+".txt"
