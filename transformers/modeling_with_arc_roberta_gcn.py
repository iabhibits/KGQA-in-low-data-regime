...
class RobertaForMultipleChoice(BertPreTrainedModel):
    ...
    def __init__(self, config,concept_emb=None,kg = None):
        ...
        self.lnormalize1 = nn.BatchNorm2d(100,100)
        self.RelAttn = Relation_Attn(self.n_embd, self.num_relations, 10000)
        self.lnormalize2 = nn.BatchNorm2d(100,100)
        self.gcn = GCN_Encoder(300,1024,100,concept_emb)
        self.layerNorm = nn.BatchNorm2((300,300)
        self.layerNorm1 = nn.BatchNorm2d(h,h)
    ...
    def forward(
        ...
        normalized_output = self.layerNorm1(combined_output)
...
class GCN_Encoder(nn.Module):
    def __init__(self,concept_dim, hidden_dim, output_dim, concept_emd):
        ...
        self.linarlayer = nn.Linear(hid_dim, 300)
        # emb_h = 13*13*1024
